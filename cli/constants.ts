...
export const PROFILE_DEFAULTS: Record<string, { agents: string[]; subagents: string[]; commands: string[] }> = {
  "k5-general": {
    ...
    commands: ["lesson-plan", "lesson-pack", "parent-email", "sub-plan", "data-tracker", "status", "resume", "handoff", "artifacts", "export", "redact", "manifest", "packs", "upgrade"]
  },
  "k5-special-ed": {
    agents: [
      "classroom-orchestrator",
    ...
    commands: ["lesson-plan", "lesson-pack", "accommodation-check", "iep-goal-support", "data-tracker", "behavior-routine", "parent-email", "sub-plan", "status", "resume", "handoff", "artifacts", "export", "redact", "manifest", "packs", "upgrade"]
  },
  "instructional-coach": {
    ...
    commands: ["lesson-plan", "lesson-pack", "data-tracker", "artifacts", "export", "redact", "packs"]
  },
  "bcba-support": {
    ...
    commands: ["behavior-routine", "data-tracker", "parent-email", "artifacts", "export", "redact", "packs"]
  },
  interventionist: {
    ...
    commands: ["lesson-plan", "data-tracker", "parent-email", "artifacts", "export", "redact", "packs"]
  }
};
